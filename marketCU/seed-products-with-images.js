...
// Product data with realistic descriptions and image URLs
const products = [
  {
    ...
    category: "Bags",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1577733966973-d680bffd2e80?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Goods",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Music",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1603048588667-c24eaedff532?w=800&auto=format&fit=crop"
  },
  {
    name: "Mountain Bike",
    price: 350.00,
    ...
    category: "Sports",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1575585269294-7d28dd912db8?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1595044426077-d36d9236d35a?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Clothing",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Furniture",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=800&auto=format&fit=crop"
  },
  {
    name: "Smart Watch",
    price: 149.99,
    ...
    category: "Electronics",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1555221236-a522e3831c82?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Games",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1586165368502-1bad197a6461?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Clothing",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1463320726281-696a485928c7?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1612036782180-6f0b6cd846fe?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Fitness",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Accessories",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1508057198894-247b23fe5ade?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Collectibles",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Stationery",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1518219051674-6dcdc0e8ed0c?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1545822835-5427ece65748?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Kitchen",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1566454912243-216f0f53d5b2?w=800&auto=format&fit=crop"
  },
  {
  ...
  },
  {
    ...
    category: "Kitchen",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1565600929907-1d6ae9ca0705?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Collectibles",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1569183602073-580599d8df15?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Decor",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1573366363233-2aa7abcb2b1d?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Goods",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1622330895344-46954629aec0?w=800&auto=format&fit=crop"
  },
  {
    name: "Telescope",
    price: 185.00,
    ...
    category: "Hobbies",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1567086305660-6f45994a9b6f?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Games",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1611371805634-050fc9ccc064?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Musical Instruments",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1602848597941-0d3d3a2c1241?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Collectibles",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1583394293214-28ded15ee548?w=800&auto=format&fit=crop"
  },
  {
    ...
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1501618669935-18b6ecb13d6d?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Accessories",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1541667558913-5510c6629f0c?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Decor",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1506377411229-4b683aec3bc5?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1598986646512-9330bcc4c0dc?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Bags",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1548877699-755d4d9a19af?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Kitchen",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1574411914555-46339e9ead5e?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Decor",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1570385253185-75d46e6cc2c6?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Kitchen",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1620057730370-013b6f8c0c49?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Accessories",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1509048191080-d2677e3a2f37?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Goods",
    condition: "Brand New",
    image_path: "https://images.unsplash.com/photo-1580301762395-83dcf0be9c87?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Home Decor",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1540932239986-30128078f3c5?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Accessories",
    condition: "Like New",
    image_path: "https://images.unsplash.com/photo-1542496658-e33a6d0d50f6?w=800&auto=format&fit=crop"
  },
  {
    name: "Indoor Plant Collection",
    price: 95.00,
    ...
    category: "Home & Garden",
    condition: "Excellent",
    image_path: "https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=800&auto=format&fit=crop"
  },
  {
    ...
    category: "Electronics",
    condition: "Good",
    image_path: "https://images.unsplash.com/photo-1510127034890-ba27508e9f1c?w=800&auto=format&fit=crop"
  }
];

// Generate Columbia email addresses
const createColumbiaEmail = (index) => {
  const unis = [
    'abc1234', 'xyz5678', 'def9012', 'ghi3456', 'jkl7890',
    'mno1357', 'pqr2468', 'stu1592', 'vwx3690', 'yz4812',
    'aaa1111', 'bbb2222', 'ccc3333', 'ddd4444', 'eee5555'
  ];
  return `${unis[index % unis.length]}@columbia.edu`;
};

// Create test users (if they don't exist)
const createUsers = async () => {
  for (let i = 1; i <= 15; i++) {
    const email = createColumbiaEmail(i-1);
...
const seedProducts = async () => {
  try {
    ...
    // Get all Columbia test users
    const usersResult = await pool.query(
      "SELECT id, email FROM users WHERE email LIKE '%@columbia.edu'"
    );
    
    const users = usersResult.rows;
    if (users.length === 0) {
      console.error('No Columbia test users found');
      return;
    }
    ...
    for (const product of products) {
      ...
      const result = await pool.query(
        ...
        (name, price, details, category, condition, seller_id, image_path) 
    ...
    console.log(`Successfully added ${count} test products with images.`);
  } catch (error) {
